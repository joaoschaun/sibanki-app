...
Logs de sessão datados (08/04/2026 → 14/06/2026) foram movidos para
`docs/_arquivo/CLAUDE-logs-sessao-ate-2026-06.md` para manter este arquivo
enxuto (regra de governança: histórico vive em `docs/CHANGELOG.md`).
Consulte o CHANGELOG para o histórico incremental por sessão.
