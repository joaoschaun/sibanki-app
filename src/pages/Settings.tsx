...
import { Database, Trash2, Upload, FileDown, FileText, MapPin, ArrowRight, Sparkles, Building2, RefreshCw, Bell, ShieldAlert, Plus, X } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <section className="bg-si-card rounded-2xl border border-si-border p-6 space-y-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            type="button"
            onClick={() => handleToggleGuardian(!guardianEnabled)}
            ...
            {addingRule ? (
              <div className="bg-si-over-1 rounded-xl p-4 space-y-3 border border-si-border">
                ...
                <div>
                  ...
                  {(budgets && Object.keys(budgets as Record<string, unknown>).length > 0) ? (
                    <select
                    ...
                    >
                      ...
                      {Object.keys(budgets as Record<string, unknown>).map((cat) => (
