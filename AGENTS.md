...
## 12. Governança do Pipeline (Comitê de Agentes + Execução)

- **Executor Mecânico:** O Antigravity opera como executor mecânico guiado por especificações de handoff em `docs/handoffs/`.
